...
const VERIFIED_JAR_SOURCES = [
  ...
  {
    url: 'https://gitlab.com/tvbox-osc/jar/-/raw/main/XC.jar',
    name: 'GitLab官方镜像',
  ...
  {
    url: 'https://jsd.onmicrosoft.cn/gh/FongMi/CatVodSpider@main/jar/custom_spider.jar',
    name: '微软CDN中国镜像',
    region: 'domestic',
    priority: 3,
  },
...
export async function GET(request: NextRequest) {
  try {
    ...
    const userRegion =
      cfCountry === 'CN' || acceptLanguage.includes('zh-CN')
        ? 'domestic'
        : 'international';
      ...
      fixed_config_urls:
        bestSources.length > 0
          ? [
              ...
              `${request.nextUrl.origin}/api/tvbox/config?mode=safe&forceSpiderRefresh=1`,
            ]
          : [],
